...
function MultiLevelForm() {
  ...
  return (
    <>
      {submitted ? (
        <div className=" font-bold  flex h-screen w-full items-center justify-center ">
          <p className=" px-10 py-3 rounded-lg text-4xl bg-gradient-to-r from-green-200 to-red-300 ">
            <span className="submit">Submitted</span>
          </p>
        </div>
      ) : (
